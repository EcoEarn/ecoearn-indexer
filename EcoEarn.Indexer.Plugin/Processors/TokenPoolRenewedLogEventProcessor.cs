...
public class TokenPoolRenewedLogEventProcessor : AElfLogEventProcessorBase<Renewed, LogEventInfo>
{
    private readonly IObjectMapper _objectMapper;
    private readonly ContractInfoOptions _contractInfoOptions;
    private readonly ILogger<TokenPoolRenewedLogEventProcessor> _logger;
    ...
    public TokenPoolRenewedLogEventProcessor(ILogger<TokenPoolRenewedLogEventProcessor> logger,
